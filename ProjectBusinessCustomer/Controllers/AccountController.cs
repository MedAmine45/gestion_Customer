    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //message.Body = "Réinitialisez votre mot de passe en cliquant <a href=\"" + callbackUrl + "\">ici</a>";
                message.Body = "Réinitialisez votre mot de passe en cliquant  " + callbackUrl + "  ici ";
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            System.Diagnostics.Debug.WriteLine("External Login Callback : " + result);
            switch (result)
            {
                case SignInStatus.Success:
                    Session["UserName"] = loginInfo.ExternalIdentity.NameClaimType;
                    System.Diagnostics.Debug.WriteLine("Session : " + loginInfo.ExternalIdentity.NameClaimType);

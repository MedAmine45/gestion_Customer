    ...
    public class EmailService
      {
        ...
        public static void SendAsync(IdentityMessage message)
        {
            ...
            //                            message.Subject,
            //                            message.Body);
            string server = ConfigurationManager.AppSettings["smtpHost"];
            ...
            client.Send(email, message.Destination, message.Subject, message.Body);
        }
